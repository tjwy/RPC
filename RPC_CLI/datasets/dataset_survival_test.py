...
class SurvivalDatasetFactory:
    ...
    def _get_label_dict(self):
        ...
        # self.label_data['class_label'] = self.label_data[self.label_col].astype(int)
...
#### 
    def get_data_to_return(self, idx):
        ...
        label = torch.Tensor([self.metadata['class_label'][idx]]) 
...
#  'tumor_size(5cm)', 
 ...
 'tumor_num(01)'
        ...
        numerical_columns = [
        #    'tumor_number',
            'age', 'WBC', 'Lymphocytes(%)', 'RBC', 'PLT', 'Alkaline_Phosphatase','tumor_dm', 'Gamma-Glutamyltransferase', 'BUN', 
            # 'AFP',
        ]
