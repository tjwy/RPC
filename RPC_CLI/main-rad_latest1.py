...
def main(args):
    ...
    for i in folds:
        ...
        results, ( train_metrics_dict,val_metrics_dict,val_iauc, acc,total_loss) = _train_val(datasets, i, args)
        ...
        # metrics_df = pd.DataFrame({
        #     'folds': [f'Fold {i+1}'],
        #     **{f'train_{key}': [train_metrics_dict.get(key, np.nan)] for key in train_metrics_dict.keys()},
